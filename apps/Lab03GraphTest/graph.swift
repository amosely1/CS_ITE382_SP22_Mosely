...
//  Lab03GraphTest
//
//  Created by Alyson Mosely on 2/16/22.
//
...
public func edgesForIndex (_index:Int ) -> [ EdgeType ] {
    return edges[_index]
}
...
public func addEdge(_e:EdgeType) {
    edges [_e.u].append(_e)
    edges [_e.v].append(_e.reversed as! EdgeType)
